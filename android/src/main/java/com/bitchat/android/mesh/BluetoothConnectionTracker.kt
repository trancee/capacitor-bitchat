...
class BluetoothConnectionTracker(
    ...
    companion object {
        ...
        private const val CONNECTION_RETRY_DELAY = AppConstants.Mesh.CONNECTION_RETRY_DELAY_MS
        private const val MAX_CONNECTION_ATTEMPTS = AppConstants.Mesh.MAX_CONNECTION_ATTEMPTS
    ...
    fun enforceConnectionLimits() {
        ...
        val maxOverall = 8//dbg?.maxConnectionsOverall?.value ?: powerManager.getMaxConnections()
        val maxClient = 8//dbg?.maxClientConnections?.value ?: maxOverall
        val maxServer = 8//dbg?.maxServerConnections?.value ?: maxOverall
