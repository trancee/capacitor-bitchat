...
final class BLEService: NSObject {
    ...
    func startServices() {
        ...
        self.delegate?.onStarted(myPeerID, success: true) // trancee
    }
    ...
    func stopServices() {
        ...
        self.delegate?.onStopped() // trancee
    }
...
extension BLEService {
    ...
    private func performMaintenance() {
        ...
        if connectedCount == 0 {
            ...
            if elapsed >= announceInterval { sendAnnounce(forceSend: true) } // trancee
        } else {
